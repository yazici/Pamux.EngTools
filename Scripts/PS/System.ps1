...
Function Restart-ServiceFabricPartitionsExample()
{

centralus
eastus
eastus2
$ConnectArgs = @{  ConnectionEndpoint = '';  
						X509Credential = $True;  
...
Restart-ServiceFabricPartition -PartitionKindSingleton 
-RestartPartitionMode AllReplicasOrInstances  
 -ServiceName fabric:/ServiceBusEntityProcessorApp/ServiceBusEntityProcessor
...
#https://ssladminhre/Details/2942264
#https://ssladminhre/Details/2942270
.\Update-ServiceFabricCluster.INT.ps1 -SubscriptionName DSE_SCID1460691_Monetization_Int -Location EastUS -ResourceGroup PartnerIncentives-Int -TemplatePrefix PartnerIncentives -Version "V2"