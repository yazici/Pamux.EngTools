...
{
	$global:RoamingAppDataRoot = [Environment]::GetFolderPath([Environment+SpecialFolder]::ApplicationData)
	$global:LocalAppDataRoot = [Environment]::GetFolderPath([Environment+SpecialFolder]::LocalApplicationData)

	$global:FreeCADDataRoot = "${global:RoamingAppDataRoot}\FreeCAD"
	$global:FreeCADMacros = "${global:FreeCADDataRoot}\Macro"
	#FreeCAD_0.17.13433
#C:\Program Files\FreeCAD 0.16\Mod\Fasteners http://theseger.com/projects/2015/06/fasteners-workbench-for-freecad/
...
function Script:SetToolPaths()
{
	...
	$global:FreeCADExe="${env:ProgramFiles}\FreeCAD_0.17.13433\bin\FreeCAD.exe"
	$global:OpenSCADExe="${env:ProgramFiles}\OpenSCAD\openscad.exe"
	# GRBL Controller https://github.com/Denvi/Candle/
	$global:CandleExe="${global:AppsRoot}\Candle\Candle.exe" 
	$global:GCAMExe="${global:AppsRoot}\gcam-se-win32-2015.05.13\gcam.exe"
