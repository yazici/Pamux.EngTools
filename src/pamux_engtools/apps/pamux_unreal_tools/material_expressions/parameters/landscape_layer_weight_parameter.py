...
class LandscapeLayerWeightParameter(ParameterBase):
    def __init__(self, parent: MaterialExpressionContainer, parameterName, defaultValue, node_pos_x = 0, node_pos_y = 0):
        super().__init__(parent, unreal.MaterialExpressionLandscapeLayerWeight, parameterName, defaultValue, node_pos_x, node_pos_y)
