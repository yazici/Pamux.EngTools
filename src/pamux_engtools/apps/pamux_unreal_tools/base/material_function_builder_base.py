...
class MaterialLayerFunctionBuilderBase(MaterialFunctionBuilderBase):
    def __init__(self, materialFunctionFactory, container_path: str, dependencies_class, inputs_class, outputs_class = MaterialFunctionOutputs.ResultAndHeight) -> None:
        super().__init__(materialFunctionFactory, container_path, dependencies_class, inputs_class, outputs_class)
